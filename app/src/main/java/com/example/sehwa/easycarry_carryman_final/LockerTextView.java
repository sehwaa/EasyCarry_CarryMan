...
public class LockerTextView extends LinearLayout {
    /**
     * TextView 01
     */
    ...
    public LockerTextView(Context context, LockerTextItem aItem) {
        super(context);

        // Layout Inflation
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.delivert_check_item_real, this, true);
